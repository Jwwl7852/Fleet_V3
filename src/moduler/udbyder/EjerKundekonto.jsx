...
export default function EjerKundekonto() {
  ...
  return <div className="ejer-konto-side">
    ...
    {fane === "forbrug" && <section className="ejer-konto-kort"><h2>Brugere og enheder</h2><p>Aftalt antal, målt forbrug og servermæssigt håndhævet grænse er tre forskellige oplysninger.</p>{antalFelt("medarbejderbrugere", "Aftalte brugere · administration og kontor", maaling?.brugere?.desktop)}{antalFelt("chauffoerbrugere", "Aftalte brugere · mobil og chauffør", maaling?.brugere?.chauffoer)}{antalFelt("enheder", "Aftalte enheder", maaling?.koeretoejer)}<p className="fc-hint">“Mobil og chauffør” gemmes fortsat i det kompatible felt <code>chauffoerbrugere</code>; kundens roller administreres i tenantdelen.</p></section>}
