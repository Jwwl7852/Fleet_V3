...
import { hentSalgsplatform, opdaterSupportsag } from "../../fleet/ejer-salgsindbakke.js";
import EjerIkon from "./EjerIkon.jsx";

const liste = (objekt) => Object.entries(objekt || {}).map(([id, post]) => ({ id, ...post }));
const STATUS = { ny: "Ny", triage: "Triage", afventer_os: "Afventer os", afventer_kunden: "Afventer kunden", loest: "Løst", lukket: "Lukket" };
