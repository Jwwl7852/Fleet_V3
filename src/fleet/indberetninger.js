...
/* Permissionen findes IKKE i permissions.js endnu, og indberetninger/ har
   ingen sensitive-node i firebase.rules.json. Den tilføjes i SAMME ombæring
   som reglerne og deres tests — ikke før. Se README's liste over noder uden
   regler. Samme fremgangsmåde som sag.sensitiveLaes fra beslutning 20. */
