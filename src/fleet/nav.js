...
export const NAV = [
  ...
  {
    key: "turtlebooking", sti: "/turtlebooking", label: "Turtlebooking", titel: "Turtlebooking",
    under: "Transportkasser, reolpladser og udlån",
    born: [
      { key: "turtlebookingKasser", sti: "/turtlebooking", label: "Kasser",
        titel: "Turtlebooking – kasser", under: "Transportkasser, type, status og plads" },
      { key: "turtlebookingKalender", sti: "/turtlebooking/kalender", label: "Kalender",
        titel: "Turtlebooking – kalender",
        under: "Kasser × dage, og listen over hvad der skal ud og hjem" },
      { key: "kasseudlaan", sti: "/turtlebooking/udlaan", label: "Udlån",
        titel: "Turtlebooking – udlån",
        under: "Søg ledige i periode, reservér, klargør, udlevér og modtag retur" },
      { key: "turtlebookingHistorik", sti: "/turtlebooking/historik", label: "Historik",
        titel: "Turtlebooking – historik",
        under: "Hvor har kassen været, og hvilke kasser var med på sagen" },
      { key: "reolpladser", sti: "/turtlebooking/reolpladser", label: "Reolpladser",
        titel: "Turtlebooking – reolpladser & kassetyper",
