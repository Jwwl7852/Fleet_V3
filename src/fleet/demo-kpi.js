...
/* ⚠ HER LÅ TO SÆT — `gods` og `bus` — fordi noden var stiformet efter
  ...
  indkoeb: {
    ...
    /* ⚠ FELTET STOD SOM null MED "INGEN KILDE" SOM GRUND. Kilden kom i
       beslutning 85: `forbrugsvarer` — Procures EGNE forbrugsvarer, ikke
       Warehouses `varer`, hvor godset er KUNDENS.

       ⚠ OG DE TO TAL HØRER SAMMEN. "0 under minimum" betyder både "alt er
       fyldt op" og "ingen har sat en grænse", hvis man ikke kan se hvor
       mange der mangler en. Derfor to felter, ikke ét. */
    lavBeholdning: 4,
    forbrugsvarerUdenGraense: 2,
