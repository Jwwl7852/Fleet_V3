  ...
  return <section className="procure-v2 procure-workspace">
    ...
    {!busy && !error && <>
      ...
      {selected && <article className="procure-card procure-workspace-detail">
        ...
        {selected.recordType === "need" && <div className="procure-actions"><Link className="procure-button" to="/ressourcer/varekatalog">Fortsæt med leverandør og varer</Link><button className="procure-button secondary" disabled={!canWrite}>Redigér kladde</button></div>}
      </article>}
    </>}
  </section>;
}
