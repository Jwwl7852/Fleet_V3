...
export const DEMO_SUPPORT_VIDEN = [{
  ...
  vidensstatus: "godkendt",
  publikum: "kunde_godkendt",
  gennemgaaetAfNavn: "Syntetisk reviewfixture",
  gennemgaaetMs: 1_799_999_000_000,
  aktuelVersion: 1,
}];
...
selvkontrol("demo-support-viden", () => {
  for (const post of DEMO_SUPPORT_VIDEN) {
    ...
    if (post.vidensstatus !== "godkendt" || post.publikum !== "kunde_godkendt") {
