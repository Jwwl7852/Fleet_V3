...
| **[BESLUTNINGER.md](BESLUTNINGER.md)** | De 32 beslutninger med begrundelser. Læs den før du bryder med noget |
...
npm run dev
npm test                            # 825 tests. Starter emulatoren.
...
skærme, og **825 tests** kører via `npm test`. `.githooks/pre-commit` gør dem
