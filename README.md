...
| 28 | **Ingen bruger- eller rollevælger i sidebaren.** Perms kommer fra tokenets claims, og en klient kan ikke ændre sit eget token. Den aktuelle persons navn vises; en anden identitet kræver log ud og nyt login, også i DEV. En eventuel demo-overstyring er kun intern og tegnes ikke som brugerrettet kontrol. Adgangsvejen (`harAdgang`) er **miljøuafhængig** og kræver et tenant-claim | `fleet/AppShell.jsx`, `App.jsx` |
