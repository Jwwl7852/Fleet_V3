...
| **[BESLUTNINGER.md](BESLUTNINGER.md)** | De 37 beslutninger med begrundelser. Læs den før du bryder med noget |
...
npm run dev
npm test                            # 957 tests. Starter emulatoren.
