...
| **[BESLUTNINGER.md](BESLUTNINGER.md)** | De 31 beslutninger med begrundelser. Læs den før du bryder med noget |
...
npm run dev
npm test                            # 790 tests. Starter emulatoren.
...
skærme, og **790 tests** kører via `npm test`. `.githooks/pre-commit` gør dem
