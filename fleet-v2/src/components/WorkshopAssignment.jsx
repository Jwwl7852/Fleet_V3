...
export function WorkshopAssignment({ caseId, onNavigate }) {
  ...
  const workshops = selectableWorkshops(relations.workshops, existing?.workshopId || caseItem?.vendorId);
  ...
  const [values, setValues] = useState({ mode: "quote", workshopId: "", recipient: "", subject: "", body: "", selectedAttachmentIds: [], communicationMode: "draft", noMailReason: "", workDescription: "" });
