...
const UDEN_KRAEVERPERM = {
  ...
  bookingOversigt:
    ...
    + "permissions som ALLE syv roller har. Der er intet at skjule for.",
  nyForespoergsel: "samme: `kunder.laes`, som alle syv roller har.",
  forslag: "samme fire brede permissions som Bookingoversigten.",
  livekort: "`koeretoejer.laes` og `personale.laes` — alle syv roller har dem.",
  bemandingPlan: "`personale.laes`, som alle syv roller har.",
  kompetencer: "samme: `personale.laes`.",
  fravaer: "`fravaer.laes` og `personale.laes` — begge hos alle syv roller.",
  indberetninger: "`koeretoejer.laes`, som alle syv roller har.",
  facilityOversigt: "`personale.laes`, som alle syv roller har.",
  kasseudlaan: "`kunder.laes`, som alle syv roller har.",
  warehouseVarer: "`kunder.laes`, som alle syv roller har.",
  warehousePluk: "samme: `kunder.laes`.",
  warehouseLabels: "`booking.laes` og `kunder.laes` — begge hos alle syv.",
  warehouseSporbarhed: "samme: `kunder.laes`.",
  enheder: "`koeretoejer.laes`, som alle syv roller har.",
  medarbejdere: "`personale.laes`, som alle syv roller har.",
  kunderOversigt: "`kunder.laes`, som alle syv roller har.",
};
