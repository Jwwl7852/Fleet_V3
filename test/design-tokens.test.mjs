...
const FORVENTEDE_TOKENS = {
  ...
  "--veyro-card-surface": "#f7f8f9",
  "--veyro-v1-workspace-background": "#e9ecef",
  "--veyro-workspace-surface": "var(--veyro-v1-workspace-background)",
  ...
  "--fc-t-xl": "17px",
  "--fc-t-subtitle": "18px",
  "--fc-t-card-title": "19px",
  "--fc-t-section": "20px",
  "--fc-t-2xl": "21px",
  "--fc-t-panel-title": "22px",
  "--fc-t-3xl": "25px",
  "--fc-t-kpi-compact": "27px",
  "--fc-t-page-compact": "29px",
  "--fc-t-kpi": "30px",
  "--fc-t-page": "32px",
  "--fc-t-4xl": "34px",
  "--fc-t-page-wide": "36px",
