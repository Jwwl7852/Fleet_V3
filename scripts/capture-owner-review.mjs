    ...
    `${JSON.stringify(
      {
        ...
        captures: [
          ...
          { file: "1920x1080-11c-tilbud-ai-revideret-kortere.png", route: "/main/salg/tilbud", viewport: "1920x1080", state: "Kladde v3; reelt kortere forslag efter sælgerinstruks" },
          { file: "1920x1080-11d-tilbud-ai-indsat.png", route: "/main/salg/tilbud", viewport: "1920x1080", state: "Kladde v3; revideret AI-forslag indsat i tilbudsteksten" },
          { file: "1440x900-11e-tilbud-tekst-ai-gemt.png", route: "/main/salg/tilbud", viewport: "1440x900", state: "Gemt tilbudstekst og Veyro-assistent side om side i 60/40-layout" },
          { file: "1920x1080-11f-tilbud-tekst-ai-gemt.png", route: "/main/salg/tilbud", viewport: "1920x1080", state: "Gemt tilbudstekst og Veyro-assistent side om side i 60/40-layout" },
